"""Token-reduction benchmark - measures how much context graph_fy saves vs naive full-corpus approach."""
from __future__ import annotations
import sys
import networkx as nx

from graph_fy.build import edge_data
from graph_fy.serve import _query_terms
...
def run_benchmark(
    ...
    """Measure token reduction: corpus tokens vs graph_fy query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\ngraph_fy token reduction benchmark")
    print(_hr(50))
    arrow = _safe("→", "->")
