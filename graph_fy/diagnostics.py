...
def _read_json_file(path: str | Path) -> dict[str, Any]:
    """Read a JSON graph after applying graph_fy's graph-load size cap."""
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "The file may be corrupted — re-run 'graph_fy extract'."
        ) from exc
...
def format_diagnostic_report(summary: dict[str, Any]) -> str:
    ...
    lines = [
        "[graph_fy] MultiDiGraph edge-collapse diagnostic",
