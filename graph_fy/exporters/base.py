"""Shared constants/helpers for the graph_fy exporters package.

Symbols used by more than one exporter live here so each exporter module can be
split out of graph_fy/export.py without a circular import (export.py and the
...
# Obsidian exporters. Moved verbatim from graph_fy/export.py.
COMMUNITY_COLORS = [
