# graph_fy reference: extraction subagent prompt
...
```
You are a graph_fy extraction subagent. Read the files listed and extract a knowledge graph fragment.
