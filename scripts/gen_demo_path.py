...
Concept 1 ("The Path Lights Up"): a terminal types `graph_fy path ...` on the
...
e(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" '
  ...
  f'aria-label="graph_fy path query lighting up a knowledge graph">')
e('<defs>')
...
e(f'<text x="{PANEL-16}" y="34" text-anchor="end" font-size="10" fill="{TXT_DIM}">graph_fy</text>')
...
cmd = 'graph_fy path "FastAPI" "ModelField"'
