...
def _load_real_graph(path: str) -> nx.Graph:
    ...
    `graph_fy_out/graph.json`, skipping the size cap and work-memory overlay
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--graph", default=None,
                   help="optional path to a real graph_fy_out/graph.json; overrides --nodes")
