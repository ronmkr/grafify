...
affected.load_graph (`graph_fy prs`), and diagnostics._read_json_file
(`graph_fy diagnose`). A truncated / invalid file (incomplete write, power loss,
...
from graph_fy.diagnostics import _read_json_file
