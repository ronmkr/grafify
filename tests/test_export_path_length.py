...
directory therefore overruns MAX_PATH, and `graph_fy export obsidian` /
...
from graph_fy import export as export_mod
from graph_fy import wiki as wiki_mod
from graph_fy.export import _obsidian_safe_stem, to_canvas, to_obsidian
from graph_fy.paths import _MIN_STEM_BUDGET, _WINDOWS_MAX_PATH, stem_filename_budget
from graph_fy.wiki import _safe_filename, to_wiki
...
def test_budget_shrinks_so_the_whole_path_fits_max_path(monkeypatch):
    ...
    vault = r"C:\Users\dev\projects\payments-api\graph_fy_out\obsidian"
