...
def test_sourceless_owned_node_is_not_an_export_definition(tmp_path):
    from graph_fy.extractors.resolution import _apply_symbol_resolution_facts
    from graph_fy.extractors.models import _SymbolResolutionFacts, _SymbolExportFact
...
def test_legacy_aggregate_pattern_facts_and_nodes_are_preserved(tmp_path):
    from graph_fy.extractors.resolution import (
        _parse_js_tree,
        _walk_js_tree,
