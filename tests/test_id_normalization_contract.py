...
Both callers now delegate to :mod:`graph_fy.ids`, so they share one
...
from graph_fy.build import _normalize_id
from graph_fy.extract import _make_id
from graph_fy.ids import make_id, normalize_id
...
def test_both_callers_share_one_implementation():
    ...
    underlying function object as graph_fy.ids.normalize_id."""
    # build._normalize_id is imported directly from graph_fy.ids.
    ...
    from graph_fy.mcp_ingest import _make_id as _mcp_make_id
    from graph_fy.symbol_resolution import _bash_make_id
