...
from graph_fy.affected import affected_nodes
from graph_fy.extract import extract, extract_python
...
def test_cross_file_indirect_survives_id_relativization(tmp_path):
    ...
    root, as the `graph_fy extract` CLI passes), the id-remap rewrites node ids
