"""Tests for the language resolver registry (graph_fy.resolver_registry).
...
from graph_fy.resolver_registry import (
    LanguageResolver,
...
def test_default_registry_contains_swift_then_python() -> None:
    ...
    import graph_fy.extract  # noqa: F401  (registers resolvers on import)
