...
from graph_fy.manifest_ingest import (
...
def test_manifests_classify_as_code_not_document(tmp_path):
    ...
    # a generic yaml is not classified as code manifest
    assert classify_file(_write(tmp_path / "config.yaml", "a: 1")) is not FileType.CODE
