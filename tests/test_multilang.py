...
import pytest
from graph_fy.extract import extract_js, extract_go, extract_rust, extract, extract_sql
...
def test_go_method_declaration_emits_refs_only_when_name_present():
    ...
    import ast
    import inspect
    from graph_fy.extract import extract_go
...
def test_mask_sql_comments_literal_and_comment_handling():
    ...
    from graph_fy.extractors.sql import _mask_sql_comments as mask
...
# from graph_fy: the point is that future edits to the live mask are
