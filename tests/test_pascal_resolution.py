...
file's own scope. graph_fy.pascal_resolution closes that gap as a
...
from graph_fy.extract import extract, extract_pascal
...
def test_calls_resolve_across_files_via_inherits_chain(tmp_path):
    # cache_root only controls where graph_fy_out/cache/ is written -- it has
...
def test_pascal_resolver_registered():
    from graph_fy.resolver_registry import registered_resolvers
