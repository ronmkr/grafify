"""Comprehensive tests for graph_fy.scip_ingest."""

from __future__ import annotations

import pytest

from graph_fy.scip_ingest import (
...
def test_relationship_edges_survive_validate_extraction_and_build():
    """Result passes graph_fy's validate_extraction and build_from_json keeps the edges."""
