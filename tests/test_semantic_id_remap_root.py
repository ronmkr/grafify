...
from graph_fy.build import _semantic_id_remap, build_from_json
...
def test_semantic_id_remap_is_idempotent_when_stem_contains_legacy_stem():
    ...
    nodes = [{"id": "claude_graph_fy_trigger",
              "source_file": ".claude/CLAUDE.md", "_origin": "semantic"}]
    first = _semantic_id_remap(nodes, ".")
    assert first == {"claude_graph_fy_trigger": "claude_claude_graph_fy_trigger"}
