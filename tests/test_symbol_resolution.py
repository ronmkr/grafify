"""Tests for graph_fy.symbol_resolution."""

from __future__ import annotations

from pathlib import Path

from graph_fy.symbol_resolution import (
    _bash_make_id,
    build_label_index,
...
def test_parse_python_import_aliases_skips_function_local_imports(tmp_path):
    ...
    from graph_fy.symbol_resolution import parse_python_import_aliases
...
def test_node_is_resolvable_symbol_requires_code_file_type():
    ...
    from graph_fy.symbol_resolution import node_is_resolvable_symbol
...
def test_build_label_index_excludes_non_code_nodes():
    ...
    from graph_fy.symbol_resolution import build_label_index
...
def test_resolve_bash_source_edges_skips_malformed_source(tmp_path):
    ...
    from graph_fy.symbol_resolution import resolve_bash_source_edges
...
def test_iter_raw_calls_skips_non_dict_per_file_entries():
    ...
    from graph_fy.symbol_resolution import iter_raw_calls
...
def test_resolve_cross_file_raw_calls_survives_malformed_raw_calls():
    ...
    from graph_fy.symbol_resolution import resolve_cross_file_raw_calls
...
def test_resolve_python_import_guided_calls_survives_malformed_raw_calls(tmp_path):
    ...
    from graph_fy.symbol_resolution import resolve_python_import_guided_calls
...
def test_resolve_python_import_guided_calls_metadata_sanitizes_hostile_alias(
    ...
    """
    import graph_fy.symbol_resolution as sr
