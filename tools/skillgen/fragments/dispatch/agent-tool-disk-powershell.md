...
```powershell
$PROJECT_ROOT = (Get-Location).Path  # cwd — where Part C globs graph_fy_out\ (NOT .graphify_root/scan dir, #1392)
# Then for chunk N: $CHUNK_PATH = Join-Path $PROJECT_ROOT "graph_fy_out\.graphify_chunk_0N.json"
```
